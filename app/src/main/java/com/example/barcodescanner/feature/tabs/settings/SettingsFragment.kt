...
import com.example.barcodescanner.feature.tabs.settings.errorcorrection.ChooseQrErrorCorrectionActivity
...
class SettingsFragment : Fragment(), DeleteConfirmationDialogFragment.Listener {
    ...
    private fun handleButtonClicks() {
        ...
        button_choose_qr_error_correction.setOnClickListener { ChooseQrErrorCorrectionActivity.start(requireContext()) }
